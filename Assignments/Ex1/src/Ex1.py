...
def Ex1(Building_json, call_csv):
    ...
    while size != 0: # ENDLESS LOOP NEED TO FIX
        ...
        if building_b.elevatorAmount == 1:# WORKS
            ...
            # print("\nThe First Call:",first_call._str_())
            ...
            for i in elev_list:
                ...
                # print("Elevator call list:",[call._str_() for call in i.callList])
            if first_call.status == 1:  # call is UP
                ...
                for src in range(first_call.originFloor, building_b.maxFloor):
                    ...
                    for e in elev_list:
                        ...
                        # print("First Call:",first_call._str_())
                        ...
                        for j in range(1, len(src_df)):  # ///////////////////////////////////////
                            ...
                            if curr_call.timeStamp > e.floor_timestamp_dict[e.maxFloor]:
                                ...
                                break
                            e.addCall(curr_call)
                            # print("Checking Call:", curr_call._str_(), "to Elevator:", e.id)
                        # print("Current number of calls in Elevator",e.id,": ",e.callAmount)
                        # print("Added Calls:", [call._str_() for call in e.callList])
...
def update_call_file(call_file, call):
    ...
    # print("\n\n\t\tDropped From Main File Call:",call._str_(),"\n\n")
...
def main():
    b1 = r"C:\Users\arieh\PycharmProjects\OOP_2021\Assignments\Ex1\data\Ex1_input\Ex1_Buildings\B1.json"
    b2 = r"C:\Users\arieh\PycharmProjects\OOP_2021\Assignments\Ex1\data\Ex1_input\Ex1_Buildings\B2.json"
    b3 = r"C:\Users\arieh\PycharmProjects\OOP_2021\Assignments\Ex1\data\Ex1_input\Ex1_Buildings\B3.json"
    b4 = r"C:\Users\arieh\PycharmProjects\OOP_2021\Assignments\Ex1\data\Ex1_input\Ex1_Buildings\B4.json"
    b5 = r"C:\Users\arieh\PycharmProjects\OOP_2021\Assignments\Ex1\data\Ex1_input\Ex1_Buildings\B5.json"


    a = r"C:\Users\arieh\PycharmProjects\OOP_2021\Assignments\Ex1\data\Ex1_input\Ex1_Calls\Calls_a.csv" # (b1, b2)
    b = r"C:\Users\arieh\PycharmProjects\OOP_2021\Assignments\Ex1\data\Ex1_input\Ex1_Calls\Calls_b.csv" # (b3, b4, b5)
    c = r"C:\Users\arieh\PycharmProjects\OOP_2021\Assignments\Ex1\data\Ex1_input\Ex1_Calls\Calls_c.csv" # (b3, b4, b5)
    d = r"C:\Users\arieh\PycharmProjects\OOP_2021\Assignments\Ex1\data\Ex1_input\Ex1_Calls\Calls_d.csv" # (b3, b4, b5)
    Ex1(b5, d)
